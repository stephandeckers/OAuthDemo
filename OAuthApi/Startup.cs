 ...
 * @Author Copilot
 * @Description Configures services and middleware for the OAuthApi application
 */
...
/// Startup class for configuring services and the application request pipeline
/// </summary>
